...
- Project page: [SAFE-ICU](https://safeicu.aiims.edu.in/project/safeicu/)
- Previous lab page: [TavLab profile](https://tavlab.iiitd.edu.in/team/pradeep-singh)
- Google Scholar: [Publications](https://scholar.google.com/citations?user=VmelJF8AAAAJ)
...
- Paper: [Early Prediction of Hemodynamic Shock in Pediatric Intensive Care Units With Deep Learning on Thermal Videos](https://pubmed.ncbi.nlm.nih.gov/35923238/)
- GitHub: [Shock-Prediction-with-Thermal-videos](https://github.com/pradeepsinghnitk/Shock-Prediction-with-Thermal-videos)
...
- Paper: [Early prediction of hypothermia in pediatric intensive care units using machine learning](https://pubmed.ncbi.nlm.nih.gov/36171970/)
...
- Preprint: [Generalizing intensive care AI across time scales in resource-limited settings](https://www.medrxiv.org/content/10.64898/2026.04.23.26351588v1)
